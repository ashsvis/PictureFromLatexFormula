        ...
        private void FillNotations()
        {
            ...
            */
            var notes = new List<Notation>()
            {
                ...
                new("Математические функции", @"\sqrt{}"),              // Квадратный корень
                new("Математические функции", @"\sqrt[3]{}"),           // Кубический корень
                new("Математические функции", @"\frac{a}{b+c}"),          // Деление: в первых скобках числитель, во вторых скобках знаменатель
                ...
                new("Ряды", @"\sum_{i=1}^{\infty} f_i"),  // Большой знак суммы
                new("Ряды", @"\prod"),                // Большой знак произведения
                new("Ряды", @"\lim_{x\to\infty}"),    // Предел
                new("Ряды", @"\int_{a}^{b}x^2 dx"),   // Интеграл
